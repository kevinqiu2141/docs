...
<head>
	...
	<script>
	function openWin(){
		url="{{urlfor "UploaderController.Read" ":bookname" .Model.Identify}}"
		myWindow=window.open(url,',','width=400,height=200');
	}
	</script>
    ...
    <header class="navbar navbar-static-top manual-head" role="banner">
        <div class="container-fluid">
            ...
            <div class="navbar-header pull-right manual-menu">
                ...
                {{end}}
		<div class="dropdown pull-right" style="margin-right: 10px;">
			<button type="button" class="btn btn-success" onclick="openWin()"><i class="fa fa-cloud-upload" aria-hidden="true"></i>上传</button>
		</div>
            </div>
        </div>
    </header>
...
<script src="{{cdnjs "/static/webuploader/webuploader.js"}}" type="text/javascript"></script>
