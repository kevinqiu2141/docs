...
import (
	...
	"github.com/1009049035/mindoc/controllers"
)
...
func init() {
	...
	beego.Router("/api/doc", &controllers.DocumentController{}, "post:GetDoc")
	...
	beego.Router("/output/:key", &controllers.DocumentController{}, "*:Output")
